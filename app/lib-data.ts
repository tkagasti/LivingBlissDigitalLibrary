...
export const libraryItems = [
  ...
  { type: "Course", title: "Shreemad Bhagavad Geeta", subtitle: "Complete 18-chapter course · 701 sequential shlokas", status: "Complete Sanskrit text", language: "Sanskrit · English · Hindi · Odia", topic: "Gita" },
